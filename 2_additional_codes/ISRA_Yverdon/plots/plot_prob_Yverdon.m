...
% load case_yverdon_Mmax37prob_45det_SiteAmpMEAN.mat
load case_yverdon_Mmax37prob_7det_SiteAmpMEAN.mat
...
set(gcf, 'renderer', 'painters');   % vector based renderer
plot(xquake./1000,fixed_IVL_prob1(:,3)./10^6,'Color',c_lblue,'LineWidth',line_w,'LineStyle','-','MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0');hold on
plot(xquake./1000,fixed_IVL_prob2(:,3)./10^6,'Color',c_orange,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.25');hold on
plot(xquake./1000,fixed_IVL_prob3(:,3)./10^6,'Color',c_lred,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.35');hold on
plot(xquake./1000,fixed_IVL_prob4(:,3)./10^6,'Color',c_red,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.5');hold on
plot(xquake./1000,fixed_IVL_prob5(:,3)./10^6,'Color',c_dark,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
...
set(gcf, 'renderer', 'painters');   % vector based renderer
plot(xquake./1000,fixed_DG_prob1(:,3),'Color',c_lblue,'LineWidth',line_w,'LineStyle','-','MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0');hold on
plot(xquake./1000,fixed_DG_prob2(:,3),'Color',c_orange,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.25');hold on
plot(xquake./1000,fixed_DG_prob3(:,3),'Color',c_lred,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.35');hold on
plot(xquake./1000,fixed_DG_prob4(:,3),'Color',c_red,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.5');hold on
plot(xquake./1000,fixed_DG_prob5(:,3),'Color',c_dark,'LineWidth',line_w,'MarkerSize',8,'Marker','*',...
    'DisplayName',  'I_a_m_p = 0.75');hold on
