function [M_Magn,IVL_tot,IVL_tot_PROB_norm,tot_loss,prob,losses,exrate,mCasSum_final,num_DG_final]=calc_loss(M_Mmin,M_dm,M_Mmax,sGMPE,sAMPL,sDISTR,sCOST,model,Mmin,Mmax,Iamp,xquake,yquake)
...
% yquake = 270420;
depth_quake = 4500;
depth_quake_km = depth_quake/1000;

%% DATA IMPORT
%% Load building stock
load bs_yverdon.mat
%  adaption to code: Building Stock's name must be "building_stock"
building_stock = bs_yverdon;
clear bs_yverdon

% site Amplification
building_stock{1}.Iamp_ECOS02=Iamp;
building_stock{1}.Iamp_ECOS09=Iamp;
...
mVi=importdata('vulnerability_classes_ems_standard.csv');   % all Vi
mVi_EMS=importdata('vulnerability_classes_yverdon_vi_EMS.csv');
...
% save(filename_det);
% 
% load det_int3_6.5_ECOS-02_BinPDF_AMPno_Expert_SER_Mmax_7.mat
