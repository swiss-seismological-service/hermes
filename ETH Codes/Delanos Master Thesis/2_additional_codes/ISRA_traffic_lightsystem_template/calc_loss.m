function [M_Magn,IVL_tot,IVL_tot_PROB_norm,tot_loss,prob,losses,exrate,mCasSum_final,num_DG_final]=calc_loss(M_Mmin,M_dm,M_Mmax,sGMPE,sAMPL,sDISTR,sCOST,model,Mmin,Mmax,rate_index)
