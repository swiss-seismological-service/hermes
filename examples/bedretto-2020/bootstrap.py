...
DIR_HYDRAULICS = "/home/sarsonl/repos/hydws/hydws/hydws/utils"
...
PATH_INJECTION_PLAN_1 = "ben_dyer_scenario_cb1_minute_sampled_20200205110837_20200206104800_193.22m.json"

PROJECT_STARTTIME_1 = datetime(2020, 2, 5, 11, 0)
PROJECT_ENDTIME_1 = datetime(2020, 2, 6, 11, 0)

FORECAST_STARTTIME_1 = datetime(2020, 2, 5, 20, 0)
...
PATH_INJECTION_PLAN_2 = "ben_dyer_scenario_cb1_minute_sampled_20200206115312_20200207101100_176.78m.json"
...
RESERVOIR = {"x": [-1000, -800, -600, -400, -200, 0, 200, 400, 600, 800, 1000],
             "y": [-1000, -800, -600, -400, -200, 0, 200, 400, 600, 800, 1000],
             "z": [-2000, -1800, -1600, -1400, -1200, -1000, -800, -600, -400,
                   -200, 0]}
...
if __name__ == '__main__':
    ...
    models = store.session.query(SeismicityModel).all()
    # create models
    ...
    with open(join(DIR_HYDRAULICS, PATH_SEISMICS), 'rb') as ifd:
    ...
    with open(join(DIR_HYDRAULICS, PATH_HYDRAULICS_1), 'rb') as ifd:
        well_1 = deserializer.load(ifd)
    print("reading: ", PATH_HYDRAULICS_2)
    with open(join(DIR_HYDRAULICS, PATH_HYDRAULICS_2), 'rb') as ifd:
    ...
    well_proj2 = store.session.query(Project).filter(Project.id == project_2.id).all()[0].wells[0]
    #well_proj2.merge(well_2)
