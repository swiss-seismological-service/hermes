# -*- encoding: utf-8 -*-
"""
Unit test for the AtlasProject class
...
class AtlasProjectTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s_patch = patch('model.atlasproject.SeismicEventHistory',
                             **s_config)
        self.h_patch = patch('model.atlasproject.HydraulicEventHistory',
                             **h_config)
    ...
    def test_init(self):
        """ Test if the AtlasProject initializes as expected. """
        self.project = AtlasProject(self.store_mock)
